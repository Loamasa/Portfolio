...
import { useUpsertCvProfile } from "@/hooks/cv";
...
export default function CVProfileForm({ profile }: CVProfileFormProps) {
  ...
  const upsertMutation = useUpsertCvProfile();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await upsertMutation.mutateAsync({
        ...
        coreStrengths: formData.coreStrengths.length > 0 ? formData.coreStrengths : null,
